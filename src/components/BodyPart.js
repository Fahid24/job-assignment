...
const BodyPart = () => {
    ...
    return (
        ...
        <div className='grid p-3 grid-cols-12 gap-2 justify-between'>
            ...
            <div className='col-span-6'>
                ...
                <div className={`
                         ...
                         ${captionBarActive
                        ? "grid grid-cols-12 gap-3 transition-left duration-500 "
                        : " hidden"}`}
                >

                    <textarea className="col-span-8 w-full h-20 mt-3 textarea-primary border border-gray-400 rounded-md" placeholder=""></textarea>
                    <MdDelete onClick={() => handleCloseCaptionInput()} className='text-3xl col-span-1 my-auto' />
                    <div className='flex flex-col col-span-3 mt-3'>
                        <input className='border input-sm   border-gray-400 rounded-md input-primary' type="text" /><br />
                        <input className='border input-sm  border-gray-400 rounded-md input-primary' type="text" />
                    </div>
                </div>
            </div>
            <div className='col-span-6'>
